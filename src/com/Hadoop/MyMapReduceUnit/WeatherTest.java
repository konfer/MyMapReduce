...
public class WeatherTest extends Configured implements Tool
{
	...
	{
		String[] args0 = {"hdfs://MyHadoopMaster:9000/data/in/weather/", "hdfs://MyHadoopMaster:9000/data/out/weatherData/"};
	...
	public static class TempratureMapper extends Mapper<LongWritable, Text, Text, IntWritable>
	{
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException
		{
			...
			if (temprature != -9999)
			{
				...
				String weatherStationid = "03103";//fileSplit.getPath().getName().substring(5, 10);
